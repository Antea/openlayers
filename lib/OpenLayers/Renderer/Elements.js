...
OpenLayers.Renderer.Elements = OpenLayers.Class(OpenLayers.Renderer, {
     ...
     */
    drawGeometry: function(geometry, style, featureId, attributes) {
        ...
        if ((className == "OpenLayers.Geometry.Collection") ||
            ...
            for (var i = 0, len=geometry.components.length; i<len; i++) {
                rendered = this.drawGeometry(
                    geometry.components[i], style, featureId, attributes) && rendered;
            }
            return rendered;
        }
     ...
     */
    redrawNode: function(id, geometry, style, featureId, attributes) {
     ...
     *     the geometry could not be drawn, false otherwise
     */
    redrawBackgroundNode: function(id, geometry, style, featureId, attributes) {
